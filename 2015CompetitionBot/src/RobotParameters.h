...
//LIFT ENCODER VALUES
	...
	//LIFT ENCODER VALUES
	#define BOTTOM_LIMIT_EV 0
	#define SCORE_HEIGHT_EV 780  //scoring platform
	#define FIRST_CONTACT_EV 1014
	#define TRANSFER_EV 2458
	#define INTERFERENCE_LOCKOUT_EV 2700
	#define TWO_STACK_EV 3323
	#define THREE_STACK_EV 4800
	#define FOUR_STACK_EV 6135
	#define FIVE_STACK_EV 7650
